...
const promotions = [
  [
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom01.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom02.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom07.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
  ],
  [
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom03.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom04.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
  ],
  [
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom05.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom06.jpg`, title: "title", description: "homepage.js, ipsum dolor sit amet" },
  ],
];
      ...
      <section className="main-sec01 main-con">
        <div className="wrap">
          ...
          <div className="right-video">
            <video src={`${process.env.PUBLIC_URL}/content/img/main/man-video05.webm`} muted autoPlay loop></video>
            <img src={`${process.env.PUBLIC_URL}/content/img/main/main_product23.png`} alt="" />
          </div>
        </div>
      </section>
              ...
              <SwiperSlide 
                ...
                <Link to={'/'}>
                  <span className="product-img">
                    <img
                      src={`${process.env.PUBLIC_URL}/content/img/main/${image}`}
                      alt={`Product ${index + 1}`}
                    />
                  </span>
                  <span className="product-tit">homepage.js Lorem ipsum dolor</span>
                </Link>
              </SwiperSlide>
            ))}
          </Swiper>
