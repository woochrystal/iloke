...
const promotions = [
  [
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom01.jpg`, title: "title", description: "home.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom02.jpg`, title: "title", description: "Lorem, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom07.jpg`, title: "title", description: "home.js, ipsum dolor sit amet" },
  ],
  [
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom03.jpg`, title: "title", description: "home.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom04.jpg`, title: "title", description: "home.js, ipsum dolor sit amet" },
  ],
  [
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom05.jpg`, title: "title", description: "home.js, ipsum dolor sit amet" },
    { img: `${process.env.PUBLIC_URL}/content/img/main/main_prom06.jpg`, title: "title", description: "home.js, ipsum dolor sit amet" },
  ],
];
                ...
                >
                  ...
                  <SwiperSlide 
                    ...
                    <Link to={'/'}>
                      ...
                      <span className="product-tit">home.js Lorem ipsum dolor</span>
                    </Link>
                  </SwiperSlide>
                ))}
              </Swiper>
