  ...
  return (
    <div className="inquiry-section">
      ...
      <form name='myFrm'>
        <div className="mypage-date-check">
          ...
          <div className="mypage-date-box">
            <input id="start-date" name="start_date" type="date" className="mypage-first-date" />
            &nbsp;-&nbsp;
            <input id="end-date" name="end_date" type="date" className="mypage-last-date" />
          </div>
          <div>
      ...
      <div className="table_container">
        <table id="boardTable">
          ...
          <tbody id="boardBody">
            {currentItems.map((item) => (
              <tr key={item.id} onClick={() => handleRowClick(item.id, item.contents, item.code, item.comment)}>
                <td>{item.id}</td>
                <td>{item.title}</td>
                {listCode === 'rv' || listCode === 'pr' ? (
                  <td>
                ...
                {listCode === 'pq' || listCode === 'ui' ? (
                  ...
                  <td style={{color: item.delete_yn === '활성' ? 'blue' : 'red'}}>
                    {item.delete_yn}
                  </td>
                )}
              </tr>
        ...
        {boardDetails && (
          <>
            <div className="modal-backdrop" onClick={() => setBoardDetails(false)}></div>
