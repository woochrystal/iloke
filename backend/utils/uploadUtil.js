...
const singleFile = (req, res, id, turn, api_url, dsct, reg_id, upt_id) => {
    return new Promise((resolve, reject) => {
        // console.log("id : " + id); // 중복되지 않을 id를 넣어주면 된다
        // 파일 업로드 미들웨어 호출
...
const fieldsFile = async (req, res, id, file_name, api_url, dsct, reg_id, upt_id) => {
    // console.log("파일시작");
    // console.log(file_name);
    return new Promise((resolve, reject) => {
        // 파일 업로드 미들웨어 호출
        const dynamicUpload = upload.fields(file_name);
